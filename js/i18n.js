...
const DICT = {
  fr: {
    tab_home: 'Boutique', tab_infos: 'Infos', tab_cart: 'Panier', tab_avis: 'Avis', tab_settings: 'Réglages',
    cart_label: 'Panier',
  ...
  en: {
    tab_home: 'Shop', tab_infos: 'Info', tab_cart: 'Cart', tab_avis: 'Reviews', tab_settings: 'Settings',
    cart_label: 'Cart',
